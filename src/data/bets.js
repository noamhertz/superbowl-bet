export const bets = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Zack Baun", odds: "+9000" },
      { label: "George Karlaftis", odds: "+9000" },
      { label: "Dallas Goedert", odds: "+12000" },
      { label: "Marquise Brown", odds: "+13000" },
      { label: "Isiah Pacheco", odds: "+13000" },
      { label: "Josh Sweat", odds: "+15000" },
      { label: "Nolan Smith", odds: "+15000" },
      { label: "Carson Wentz", odds: "+20000" },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Xavier Worthy", odds: "+1100" },
      { label: "Travis Kelce", odds: "+1000" },
      { label: "Kareem Hunt", odds: "+900" },
      { label: "Jalen Hurts", odds: "+650" },
      { label: "Saquon Barkley", odds: "+450" },
    ],
  },
  {
    id: 10,
    ...
    options: [
      ...
      { label: "A.J. Brown", odds: "+165" },
      { label: "Xavier Worthy", odds: "+155" },
      { label: "Travis Kelce", odds: "+140" },
      { label: "Kareem Hunt", odds: "+140" },
      { label: "Jalen Hurts", odds: "-110" },
      { label: "Saquon Barkley", odds: "-195" },
    ],
  },
  {
    id: 11,
    ...
    options: [
      ...
      { label: "A.J. Brown", odds: "+1200" },
      { label: "Xavier Worthy", odds: "+1200" },
      { label: "Travis Kelce", odds: "+1000" },
      { label: "Kareem Hunt", odds: "+950" },
      { label: "Jalen Hurts", odds: "+550" },
      { label: "Saquon Barkley", odds: "+285" },
    ],
  },
  {
    id: 12,
    ...
    options: [
      ...
      { label: "Turnover/Downs/Safety", odds: "+650" },
    ],
  },
  {
    id: 13,
    ...
    options: [
      ...
      { label: "Turnover/Downs/Safety", odds: "+600" },
    ],
  },
  {
    id: 14,
    ...
    options: [
      ...
      { label: "KC Win By 13-18 points", odds: "+900" },
      { label: "KC Win By 19-24 points", odds: "+2200" },
      { label: "KC Win By 25-30 points", odds: "+4500" },
      { label: "KC Win By 31-36 points", odds: "+8000" },
      { label: "KC Win By 37-42 points", odds: "+11000" },
      { label: "KC Win By 43+ points", odds: "+11000" },
      { label: "PHI Win By 1-6 points", odds: "+270" },
      { label: "PHI Win By 7-12 points", odds: "+475" },
      { label: "PHI Win By 13-18 points", odds: "+1000" },
      { label: "PHI Win By 19-24 points", odds: "+2200" },
      { label: "PHI Win By 25-30 points", odds: "+5000" },
      { label: "PHI Win By 31-36 points", odds: "+8000" },
      { label: "PHI Win By 37-42 points", odds: "+11000" },
      { label: "PHI Win By 43+ points", odds: "+11000" },
    ],
  },
  {
    id: 15,
